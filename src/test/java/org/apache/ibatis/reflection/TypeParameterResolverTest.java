...
public class TypeParameterResolverTest {
  ...
  public void test1() throws NoSuchFieldException, NoSuchMethodException {
    TypeVariable<Class<G>>[] typeParameters = G.class.getTypeParameters();
    Type[] typeParameters2 =  ((Class<?>) ((ParameterizedType)G.class.getGenericSuperclass()).getRawType()).getTypeParameters();
    TypeVariable<Class<A>>[] typeParameters1 = A.class.getTypeParameters();

    Method getAbc = C.class.getMethod("getAbc");
    Type type1 = TypeParameterResolver.resolveReturnType(getAbc, A.class);
    Type type2 = TypeParameterResolver.resolveReturnType(getAbc, B.class);
    Type type3 = TypeParameterResolver.resolveReturnType(getAbc, C.class);
    Type type4 = TypeParameterResolver.resolveReturnType(getAbc, D.class);
    Type type5 = TypeParameterResolver.resolveReturnType(getAbc, E.class);
    Type type6 = TypeParameterResolver.resolveReturnType(getAbc, F.class);
    Type type7 = TypeParameterResolver.resolveReturnType(getAbc, G.class);
    Type type8 = TypeParameterResolver.resolveReturnType(getAbc, H.class);
    Type type9 = TypeParameterResolver.resolveReturnType(getAbc, I.class);
    System.out.println();
  }
}
